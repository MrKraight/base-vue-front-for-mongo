...
<template>
    <fieldset>
        ...
        <div class="d-flex mb-2">
            <span style="font-size: 15px; font-weight: 300;">{{ modelValue.name }}</span>
            <div @click="removeFile()" class="bg-danger d-flex justify-content-center rounded-circle ms-3" style="width: 21px; height: 21px; cursor: pointer;">
